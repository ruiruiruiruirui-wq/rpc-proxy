...
local near_nownodes_api_key = os.getenv("NEAR_NOWNODES_API_KEY")
if not nownodes_api_key or near_nownodes_api_key == "" then
    ngx.log(ngx.ERR, "NEAR_NOWNODES_API_KEY not found in environment variables")
end
...
local backends = {
    near = {
        -- { url = "https://purple-bold-hill.near-mainnet.quiknode.pro/" .. (os.getenv("PURPLE_BOLD_HILL") or "") .. "/", host = "purple-bold-hill.near-mainnet.quiknode.pro" },
        -- { url = "https://clean-snowy-log.near-mainnet.quiknode.pro/" .. (os.getenv("CLEAN_SNOWY_LOG") or "") .. "/", host = "clean-snowy-log.near-mainnet.quiknode.pro" }
	{ url="https://near.nownodes.io/" .. (os.getenv("NEAR_NOWNODES_API_KEY") or "") .. "/", host= "near.nownodes.io" }
    }
}
